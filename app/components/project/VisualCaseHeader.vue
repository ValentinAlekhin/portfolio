...
.visual-case-hero__summary { max-width: 42rem; margin: 2rem 0 0; color: var(--color-text-muted); font-family: var(--font-mono); font-size: var(--font-size-small); line-height: 1.7; }
...
.visual-case-hero__facts dt { color: var(--color-text-muted); font-family: var(--font-mono); font-size: var(--font-size-ui); }
...
@media (max-width: 650px) {
  ...
  .visual-case-hero[data-variant='nordhus'] h1 { font-size: clamp(2.75rem, 13vw, 4.5rem); }
  .visual-case-hero[data-variant='aerovista'] h1 { font-size: clamp(2.8rem, 13vw, 4.5rem); }
