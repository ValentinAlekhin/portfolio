...
export const projects: Project[] = [
  {
    slug: 'powersketch',
    statisticsPeriodKey: 'projects.entries.powersketch.metrics.period',
    index: '01',
    title: 'PowerSketch',
    period: '2024—NOW',
    status: 'live',
    ...
    brief: { taskKey: 'projects.entries.powersketch.brief.task', solutionKey: 'projects.entries.powersketch.brief.solution', resultKey: 'projects.entries.powersketch.brief.result' },
    ...
    metrics: [
      { valueKey: 'projects.entries.powersketch.metrics.visitorsValue', labelKey: 'projects.entries.powersketch.metrics.visitors' },
      { valueKey: 'projects.entries.powersketch.metrics.visitsValue', labelKey: 'projects.entries.powersketch.metrics.visits' },
      { valueKey: 'projects.entries.powersketch.metrics.viewsValue', labelKey: 'projects.entries.powersketch.metrics.views' },
    ],
    media: [
      {
        id: 'editor',
  ...
  },
  {
    ...
    brief: { taskKey: 'projects.entries.planesArch.brief.task', solutionKey: 'projects.entries.planesArch.brief.solution', resultKey: 'projects.entries.planesArch.brief.result' },
  ...
  },
  {
    ...
    brief: { taskKey: 'projects.entries.nordhus.brief.task', solutionKey: 'projects.entries.nordhus.brief.solution', resultKey: 'projects.entries.nordhus.brief.result' },
  ...
  },
  {
    ...
    brief: { taskKey: 'projects.entries.aerovista.brief.task', solutionKey: 'projects.entries.aerovista.brief.solution', resultKey: 'projects.entries.aerovista.brief.result' },
    ...
    media: [
      visualProjectMedia('aerovista', 'cover', 2400, 1500, 'viewport'),
      visualProjectMedia('aerovista', 'homeFull', 2513, 16383, 'full-page', 'home-full'),
      visualProjectMedia('aerovista', 'homeMobileFull', 442, 16383, 'phone', 'home-mobile-full'),
      visualProjectMedia('aerovista', 'homeMobile', 1200, 2597, 'phone', 'home-mobile'),
  ...
  },
  {
    ...
    brief: { taskKey: 'projects.entries.kineo.brief.task', solutionKey: 'projects.entries.kineo.brief.solution', resultKey: 'projects.entries.kineo.brief.result' },
  ...
  },
  {
    ...
    brief: { taskKey: 'projects.entries.forma.brief.task', solutionKey: 'projects.entries.forma.brief.solution', resultKey: 'projects.entries.forma.brief.result' },
    ...
    media: [
      visualProjectMedia('forma', 'cover', 2400, 1500, 'viewport'),
      ...
      visualProjectMedia('forma', 'catalogFull', 5760, 11452, 'full-page', 'catalog-full'),
      visualProjectMedia('forma', 'catalogMobileFull', 1560, 13300, 'phone', 'catalog-mobile-full'),
      ...
      visualProjectMedia('forma', 'productCupFull', 5760, 10108, 'full-page', 'product-cup-full'),
      visualProjectMedia('forma', 'productBowlFull', 5760, 10108, 'full-page', 'product-bowl-full'),
      visualProjectMedia('forma', 'productVaseMobileFull', 1560, 13228, 'phone', 'product-vase-mobile-full'),
      visualProjectMedia('forma', 'cart', 2400, 1500, 'modal'),
      visualProjectMedia('forma', 'cartMobile', 1200, 2597, 'phone', 'cart-mobile'),
      visualProjectMedia('forma', 'checkout', 2400, 1500, 'modal'),
      visualProjectMedia('forma', 'checkoutMobile', 1200, 2597, 'phone', 'checkout-mobile'),
      visualProjectMedia('forma', 'filtersMobile', 1200, 2597, 'phone', 'filters-mobile'),
    ],
